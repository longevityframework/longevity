...
libraryDependencies += "org.longevityframework" %% "longevity" % "0.13.0"
```
...
```scala
libraryDependencies += "org.longevityframework" %% "longevity-cassandra-deps" % "0.13.0"

libraryDependencies += "org.longevityframework" %% "longevity-mongo-deps" % "0.13.0"
```
