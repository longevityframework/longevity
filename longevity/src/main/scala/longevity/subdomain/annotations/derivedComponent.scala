 ...
 * companion object for the class that extends [[longevity.subdomain.DerivedCType
...
private object derivedComponent {
  ...
  private abstract class DerivedComponentImpl extends AbstractComponentImpl {
    ...
    protected def innerCType =
      q"object ctype extends longevity.subdomain.DerivedCType[$termName.type, $polyTypeName]"
