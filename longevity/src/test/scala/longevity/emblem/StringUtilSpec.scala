...
class StringUtilSpec extends FlatSpec with GivenWhenThen with Matchers {
  ...
  behavior of "longevity.emblem.stringUtil.uncapitalize"
  ...
  behavior of "longevity.emblem.stringUtil.camelToUnderscore"
  ...
  behavior of "longevity.emblem.stringUtil.underscoreToCamel"
  ...
  behavior of "longevity.emblem.stringUtil.typeFullname"
  it should "return the fullname for a type" in {
    typeFullname(typeKey[String].tpe) should equal ("java.lang.String")
    typeFullname(typeKey[Foo].tpe) should equal ("longevity.emblem.StringUtilSpec.Foo")
  }

  behavior of "longevity.emblem.stringUtil.typeName"
  ...
  behavior of "longevity.emblem.stringUtil.typeNamePrefix"
  it should "return the name prefix for a type" in {
    typeNamePrefix(typeKey[String].tpe) should equal ("java.lang")
    typeNamePrefix(typeKey[Foo].tpe) should equal ("longevity.emblem.StringUtilSpec")
  }
