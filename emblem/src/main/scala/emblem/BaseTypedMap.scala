...
/** an abstract base class for shared functionality of [[TypeKeyMap]] and [[TypedMap]] */
private[emblem] abstract class BaseTypedMap[TypeBound, Key[_ <: TypeBound], Val[_ <: TypeBound]] (
