...
/** an exception thrown when [[emblem.traversors.sync.TestDataGenerator TestDataGenerator]] cannot generate
 * requested data due to encountering an unsupported type.
 */
