 ...
 *
 * we similarly do not attempt to differentiate between
 * [[emblem.emblematic.Union Union]] values representing different constituent
 * types. we just report that the type doesn't match.
 *
...
class Differ(
   ...
   * @throws emblem.exceptions.CouldNotTraverseException when an unsupported
