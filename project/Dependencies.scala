...
object Dependencies {
  ...
  val akkaStreamDep:     ModuleID = "com.typesafe.akka"          %% "akka-stream"           % "2.5.6"
  ...
  val mongodbDep:        ModuleID = "org.mongodb"                %  "mongodb-driver"        % "3.5.0"
  ...
  val scalaTestDep:      ModuleID = "org.scalatest"              %% "scalatest"             % "3.0.4"
  val slf4jSimpleDep:    ModuleID = "org.slf4j"                  %  "slf4j-simple"          % "1.7.25"
  val sqliteDep:         ModuleID = "org.xerial"                 %  "sqlite-jdbc"           % "3.20.1"
  ...
  val typesafeConfigDep: ModuleID = "com.typesafe"               %  "config"                % "1.3.2"
